...
- **Import/Export**: 설정을 파일로 내보내고 가져오기 (차이점 비교 기능 포함)
...
- **저장 후 진행**: 경고 팝업 닫기 → 설정 저장 → 원래 작업 진행
...
**버튼 동작**:
- **취소**: 팝업 닫기
- **삭제**: 목록에서 Assay 제거 → "저장되지 않은 변경사항" 표시

### 5.4 백업 파일 삭제 확인

**트리거**: 백업 파일 목록에서 삭제 버튼 클릭
...
**버튼 동작**:
- **취소**: 팝업 닫기
- **삭제**: 서버에서 파일 삭제 → 목록에서 제거 → 성공 메시지 표시
